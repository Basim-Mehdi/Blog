...
![Docker Chall Working Image](/static/images/ctfd/docker-working-fine.png) - **Congrats!** The plugin is working superbly ⚡😎 (go ahead, brag a little).
...
- Now Bring the challenges that works on Docker to Cloud in a similar way we brought the ctfd.zip file. - Zip the `challenge` directory on your local machine:
  `bash
