...
5. In SSL/TLS settings:
   ...
   ![Cloudflare SSL Overview](/static/images/ctfd/cloudflare_ssl_overview.png)
   
      - Click on Configure -> Scroll Down -> Select Flexible -> Save

   ![Cloudflare SSL Configure](/static/images/ctfd/cloudflare_ssl_configure.png)

6. Enable **Firewall Rules** to filter unwanted traffic.

![Cloudflare DNS Settings](/static/images/ctfd/cloudflare-dns.png)
