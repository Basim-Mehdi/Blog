    ...
    <>
      <div>
        ...
        <div className="flex sm:space-x-24">
          <div className="h-full max-h-screen max-w-[280px] min-w-[280px] flex-wrap overflow-auto rounded-sm bg-gray-50 pt-5 shadow-md sm:flex dark:bg-gray-900/70 dark:shadow-gray-800/40">
                  ...
                  <li key={path} className="py-5">
                    <article className="flex flex-col space-y-2 xl:space-y-0">
                      <dl>
                        ...
                        <dd className="text-base leading-6 font-medium text-red-700 dark:text-red-400">
                      ...
                      <div className="space-y-3">
                        <div>
                          <h2 className="text-2xl leading-8 font-bold tracking-tight">
                            <Link href={`/${path}`} className="text-gray-900 dark:text-white">
                              {title}
                            </Link>
                          </h2>
